<h1><img src="assets/images/logo-mark.png" alt="RTTIST - reflection" align="left" height="40" style="padding: 0 20px 0 0;vertical-align: middle;"> RTTIST</h1>
...
- esbuild,
- Vite,
- SWC (currently obsolete),
- ts-patch/ttypescript (~~work in progress~~ postponed).
