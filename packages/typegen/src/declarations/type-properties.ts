 ...
 */
export type BaseTypeProperties = Match<
	keyof TypeMetadata,
	{
		id?: TypeIdentifier;
		kind: TypeKind;
...
export type NativeBaseTypeProperties = Omit<BaseTypeProperties, "id" | "kind"> & {
	kind: NativeTypeKind;
	id?: undefined;
};

export type NonNativeBaseTypeProperties = Match<
	keyof Omit<BaseTypeProperties, "id">,
	{
		kind: TypeKind;
		name: string;
		module?: ModuleIdentifier;
...
export type ParameterProperties = Match<
	keyof ParameterInfoMetadata,
	{
		name: string;
...
export type SignatureProperties = Match<
	keyof SignatureMetadataBase,
	{
...
export type MethodProperties = Match<
	keyof MethodInfoMetadata,
	{
		flags: MethodFlags;
...
export type PropertyProperties = Match<
	keyof PropertyInfoMetadata,
	{
		name: MemberNameProperties;
		flags: PropertyFlags;
		type: TransformerTypeReference;
...
export type ConditionalTypeProperties = Match<
	keyof Omit<ConditionalTypeMetadata, "id">,
...
export type DecoratorProperties = Match<
	keyof DecoratorInfoMetadata,
	{
		name: string;
		id: TypeIdentifier;
		args?: Array<any>;
...
export type ObjectProperties = Match<
	keyof Omit<ObjectLikeBaseTypeMetadata, "id">,
	NonNativeBaseTypeProperties & {
...
export type ClassProperties = Match<
	keyof Omit<ClassTypeMetadata, "id">,
	ObjectProperties & {
		ctor?: ImportDetails;
...
export type InterfaceProperties = Match<
	keyof Omit<InterfaceTypeMetadata, "id">,
	ObjectProperties & {
		extends?: TransformerTypeReference[];
	}
>;

export type TypeAliasProperties = Match<
	keyof Omit<TypeAliasTypeMetadata, "id">,
	NonNativeBaseTypeProperties & {
		target: TransformerTypeReference;
	}
>;

export type UniqueSymbolProperties = Match<
	keyof Omit<UniqueSymbolTypeMetadata, "id">,
	NonNativeBaseTypeProperties & {
		key?: string;
	}
>;

export type EnumProperties = Match<
	keyof Omit<EnumTypeMetadata, "id">, // TODO: Refactor names of types and properties. EnumType vs Enum? Function vs FunctionType, Object vs ObjectType
	NonNativeBaseTypeProperties & {
		kind: TypeKind.Enum;
		const: boolean;
...
export type EnumLiteralProperties = Match<
	keyof Omit<EnumLiteralTypeMetadata, "id">, // TODO: Refactor names of types and properties. EnumType vs Enum? Function vs FunctionType, Object vs ObjectType
	NonNativeBaseTypeProperties & {
...
export type FunctionProperties = Match<
	keyof Omit<FunctionTypeMetadata, "id">, // TODO: Refactor names of types and properties. EnumType vs Enum? Function vs FunctionType, Object vs ObjectType
	NonNativeBaseTypeProperties & {
