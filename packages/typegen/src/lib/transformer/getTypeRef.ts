...
// import { getSymbol, getTypeId, getUniqueSymbolName, isInvalidType } from "./utils/typeHelpers";
//
// /**
...
//
// 	if (sourceFile.fileName !== undefined && !canIncludeSourceFile(sourceFile.fileName, transformerContext.config)) {
// 		return TransformerTypeReference.Invalid;
// 	}
//
...
// 					return new TransformerTypeReference(ModuleIds.Native, "UniqueSymbol@" + name);
// 				}
// 			}
//
...
// }
//
// function getUnionOrIntersectionTypeRef(
// 	type: ts.Type,
// 	symbol: ts.Symbol | undefined,
// 	transformerContext: TransformerContext
// ) {
