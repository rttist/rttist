...
// TODO: I had to add typeof; review this
export type NativeTransformerTypeReference = typeof TransformerTypeReference & {
...
export class TransformerTypeReference {
	public static readonly Invalid = new TransformerTypeReference(TypeIds.Invalid);
	public static readonly Any = new TransformerTypeReference(TypeIds.Any);
	public static readonly Void = new TransformerTypeReference(TypeIds.Void);
