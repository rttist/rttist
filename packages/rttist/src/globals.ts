...
import type { ModuleMetadata, TypeReference } from "./declarations";

declare global {
	interface ImportMeta {
		/**
		 * Metadata of the module.
		 * @remarks This must be implemented by a transformer.
		 */
		readonly metadata: Omit<ModuleMetadata, "import">;
	}
	...
	namespace Reflect {
		 ...
		 */
		export function getGenericClass<TType>(
			classCtor: Function,
			...typeParameters: Type[]
		): { new (...args: any): TType } | Function;
	}
}
