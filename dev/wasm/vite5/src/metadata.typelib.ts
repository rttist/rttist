...
ModuleImporter.registerImporters({
	"@dev-wasm-vite5/App": () => import("./App.js"),
	"@dev-wasm-vite5/index": () => import("./index.js"),
	"@dev-wasm-vite5/types/Component": () => import("./types/Component.js"),
	"@dev-wasm-vite5/types/Parameter": () => import("./types/Parameter.js"),
	"@dev-wasm-vite5/types/Signature": () => import("./types/Signature.js"),
});
